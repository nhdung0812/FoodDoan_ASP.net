<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="FoodDoAn.index" %>
        ...
        <section class="ftco-section ftco-category ftco-no-pt">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(images/img/food/category-3.jpg);">
                            <div class="text px-3 py-1">
